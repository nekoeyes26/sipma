            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                    <div class="p-5 rounded contact-form">
                        <form class="bg-white p-4 rounded-3" action="/bakpk/register/pimpinan" method="POST">
                            @csrf
                            <h2 class="text-center mb-4">Daftarkan Pimpinan</h2>
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama</label>
                                <input type="text" id="nama" class="form-control" name="nama" required>
                            </div>
                            <div class="mb-3">
                                <label for="nomorIdentitas" class="form-label">NIP</label>
                                <input type="text" id="nomorIdentitas" class="form-control" name="nip_pimpinan"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="bagian" class="form-label">Bagian</label>
                                <select id="bagian" class="form-select" name="bagian" required>
                                    <option value="">Pilih Bagian Yang Diampu</option>
