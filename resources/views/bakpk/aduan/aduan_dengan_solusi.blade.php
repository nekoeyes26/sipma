            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-center" href="{{ route('bakpk.aduan.dengan_solusi') }}"> Aduan Dengan Solusi </a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="main">
                <div class="table-container">
                    <div
                        ...
                        <h1 class="h2">List Aduan Dengan Solusi</h1>
                        <div class="btn-group">
                        ...
                        <table class="table table-striped" id="sortable-table">
                            <thead>
                                <tr>
                                    ...
                                    <th onclick="sortTable(4)">Level Aduan</th>
                                    <th onclick="sortTable(5)">BAKPK</th>
                                    <th onclick="sortTable(6)">Solusi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($data_aduan as $aduan)
                                    <tr>
                                        ...
                                        <td>{{ $aduan->transaksi_aduan->first()->id_bakpk ?? 'N/A' }}</td>
                                        <td>{{ $aduan->transaksi_aduan->first()->id_solusi ?? 'N/A' }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
