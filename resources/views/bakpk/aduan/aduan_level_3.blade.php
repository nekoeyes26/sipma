            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link text-center" href="{{ route('bakpk.aduan.baru') }}"> Aduan Baru </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-center" href="{{ route('bakpk.aduan.level3') }}"> Aduan Level 3 </a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="main">
                <div class="table-container">
                    <div
                        ...
                        <h1 class="h2">List Aduan Dengan Level 3</h1>
                        <div class="btn-group">
                            ...
                            <tbody>
                                @foreach ($data_aduan as $aduan)
                                    <tr>
                                        ...
                                        <form method="POST"
                                            action="{{ route('bakpk.aduan.update', $aduan->id_aduan) }}">
                                            @csrf
                                            <td>
                                                <select class="form-select" name="level_aduan">
                                                    @if (in_array($aduan->level_aduan, [1, 2, 3]))
                                                        <option value="1"
                                                            {{ $aduan->level_aduan == 1 ? 'selected' : '' }}>1</option>
                                                        <option value="2"
                                                            {{ $aduan->level_aduan == 2 ? 'selected' : '' }}>2</option>
                                                        <option value="3"
                                                            {{ $aduan->level_aduan == 3 ? 'selected' : '' }}>3</option>
                                                    @else
