            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-center" href="{{ route('bakpk.aduan.menunggu_solusi') }}"> Aduan Menunggu Solusi </a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="main">
                <div class="table-container">
                    <div
                        ...
                        <h1 class="h2">List Aduan Menunggu Solusi</h1>
                        <div class="btn-group">
                            ...
                            <tbody>
                                @foreach ($data_aduan as $aduan)
                                    <tr>
                                        ...
                                        <td>{{ $aduan->transaksi_aduan->first()->bakpk->nama ?? 'N/A' }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
