            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link text-center" href="{{ route('pimpinan.aduan') }}"> Aduan Diterima
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-center" href="{{ route('pimpinan.aduan.sarana') }}"> Aduan
                                Sarana Prasarana
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="main">
                <div class="table-container">
                    <div
                        ...
                        <h1 class="h2">List Aduan Sarana Prasarana</h1>
                        {{-- <div class="btn-group">
