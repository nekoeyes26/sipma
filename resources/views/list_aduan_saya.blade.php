...
<body>
    ...
    <div class="container-fluid">
        <div class="row px-lg-5">
            <!-- Main Content -->
            <main class="col-md-12 ms-sm-auto px-lg-5" id="main">
                <div class="table-container">
                    <div
                        class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Daftar Aduan Saya</h1>
                        <div class="btn-group">
                            ...
                            <tbody>
                                ...
                                @foreach ($data_aduan as $aduan)
                                    <tr>
                                        ...
                                        <td>{{ $aduan->tanggal_kirim }}</td>
                                        @if (
                                            $aduan->transaksi_aduan &&
                                                $aduan->transaksi_aduan->first() &&
                                                $aduan->transaksi_aduan->first()->solusi &&
                                                $aduan->transaksi_aduan->first()->solusi->solusi)
